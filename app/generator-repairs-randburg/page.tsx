...
export const metadata: Metadata = {
  ...
  description:
    'Professional generator repairs, servicing and emergency callouts across Randburg. Ferndale, Bordeaux, Blairgowrie, Northcliff — mobile technicians come to you. Call 076 347 3736.',
  keywords: [
  ...
  alternates: {
    canonical: 'https://www.generatorgents.co.za/generator-repairs-randburg',
  },
  openGraph: {
    title: 'Generator Repairs Randburg | Same-Day Service, All Randburg Areas',
    description:
      'Expert generator repairs and emergency callouts across Randburg. Mobile technicians, same-day response. Call 076 347 3736.',
    url: 'https://www.generatorgents.co.za/generator-repairs-randburg',
    type: 'website',
  },
}
            ...
            <div>
              ...
              <div className="space-y-5 text-base md:text-lg leading-relaxed text-[#1a1a1a]/70">
                <p>
                  ...
                  landscape. Generator Gents provides tailored generator repair, servicing,
