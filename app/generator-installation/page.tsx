...
export const metadata: Metadata = {
  ...
  description:
    'Professional generator installation across Gauteng. Site assessment, foundation, fuel lines, electrical connections, changeover switch wiring and full commissioning. SANS compliant. Call 076 347 3736.',
  keywords: [
  ...
  alternates: {
    canonical: 'https://www.generatorgents.co.za/generator-installation',
  },
  openGraph: {
    title: 'Generator Installation Gauteng | Professional Setup, Wiring & Commissioning',
    description:
      'Professional generator installation across Gauteng. Site assessment, fuel lines, electrical connections, changeover switch and commissioning. SANS compliant. Call 076 347 3736.',
    url: 'https://www.generatorgents.co.za/generator-installation',
    type: 'website',
  },
}
            ...
            <div>
              ...
              <div className="space-y-5 text-base md:text-lg leading-relaxed text-[#1a1a1a]/70">
                <p>
                  ...
                  Generator Gents provides professional installation services that ensure
