...
export const metadata: Metadata = {
  ...
  description:
    'Expert generator repair services across Gauteng. Certified technicians diagnose and fix all faults — electrical, mechanical, fuel & control systems — on all brands. Most repairs completed on the first visit. Call 076 347 3736.',
  keywords: [
  ...
  alternates: {
    canonical: 'https://www.generatorgents.co.za/generator-repairs',
  },
  openGraph: {
    title: 'Generator Repairs Gauteng | Same-Day Fault Diagnosis & Repair',
    description:
      'Certified generator repair technicians across Gauteng. All brands, all faults. Most repairs completed on the first visit. Call 076 347 3736.',
    url: 'https://www.generatorgents.co.za/generator-repairs',
    type: 'website',
  },
}
            ...
            <div>
              ...
              <div className="space-y-5 text-base md:text-lg leading-relaxed text-[#1a1a1a]/70">
                <p>
                  ...
                  problem and implement an effective repair. Generator Gents brings over
