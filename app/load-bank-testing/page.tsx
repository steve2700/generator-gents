...
export const metadata: Metadata = {
  ...
  description:
    'Professional load bank testing for standby generators across Gauteng. Verify rated output, clear wet stacking, and get compliance documentation for insurers. Tested at 50%, 75% and 100% capacity. Call 076 347 3736.',
  keywords: [
  ...
  alternates: {
    canonical: 'https://www.generatorgents.co.za/load-bank-testing',
  },
  openGraph: {
    title: 'Load Bank Testing Gauteng | Generator Capacity Verification',
    description:
      'Load bank testing for standby generators across Gauteng. Rated output verified at 50%, 75% and 100% capacity. Compliance documentation included. Call 076 347 3736.',
    url: 'https://www.generatorgents.co.za/load-bank-testing',
    type: 'website',
  },
}
