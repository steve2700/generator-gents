...
export const metadata: Metadata = {
  ...
  description:
    'Generator repairs and servicing across all of Gauteng — Johannesburg, Pretoria, Sandton, Midrand, Centurion, East Rand, West Rand & more. Mobile technicians come to you. Call 076 347 3736.',
  keywords: [
  ...
  alternates: {
    canonical: 'https://www.generatorgents.co.za/areas',
  },
  openGraph: {
    title: 'Generator Repair Service Areas Gauteng | All Towns & Suburbs',
    description:
      'Mobile generator repair technicians covering all of Gauteng. Same-day emergency callouts. Call 076 347 3736.',
    url: 'https://www.generatorgents.co.za/areas',
    type: 'website',
    images: [{ url: '/og-image.jpg', width: 1200, height: 630, alt: 'Generator Gents — Gauteng service areas' }],
  },
}
